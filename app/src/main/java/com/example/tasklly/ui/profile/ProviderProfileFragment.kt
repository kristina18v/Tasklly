...
class ProviderProfileFragment : Fragment(R.layout.fragment_profile_provider) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val optEdit = view.findViewById<View>(R.id.optEditProfile)
        val optArchive = view.findViewById<View>(R.id.optArchive)
        val optServices = view.findViewById<View>(R.id.optMyServices)
        val optPass = view.findViewById<View>(R.id.optChangePassword)

        tvRole.text = "Provider"
        ...
        // Clicks
        optEdit.setOnClickListener {
            startActivity(Intent(requireContext(), EditProfileActivity::class.java))
        }

        optArchive.setOnClickListener {
            startActivity(
                Intent(requireContext(), ArchiveActivity::class.java)
                    .putExtra("mode", "provider")
            )
        }

        optServices.setOnClickListener {
            // Стави си MyServicesActivity кога ќе ја направиш
        ...
        ref.putFile(uri)
            .addOnSuccessListener {
                ref.downloadUrl.addOnSuccessListener { downloadUri ->
                    db.child("users").child(uid).child("photoUrl")
